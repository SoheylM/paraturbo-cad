...
alpha_HG =0.68# Element['parameters']['hgjb1']['alpha']#0.68 #given
beta_HG = -135#Element['parameters']['hgjb1']['beta'] #-135 #given-135 #given 
beta_HG = beta_HG*pi/180
gamma_HG = 0.89#Element['parameters']['hgjb1']['gamma'] #0.89 #given
