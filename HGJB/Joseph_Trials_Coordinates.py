...
mir[0] = translation((0, 0, 60)).transformAll(profile[0])
mir1[0] = translation((0, 0, 60)).transformAll(profile1[0])
usa[0]=[mir[0],mir1[0]]

tra[0] = translation((0, 0, 60)).transformAll(mirrored_pts[0])
tra1[0] = translation((0, 0, 60)).transformAll(mirrored_pts1[0])
usa2[0]=[tra[0],tra1[0]]
