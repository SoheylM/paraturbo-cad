...
points = 50
edge_hgjb1_first = cq.Edge.makeSpline([cq.Vector(p) for p in coords_hgjb1_first][0:-1]).close()
show_object(edge_hgjb1_first)
edge_hgjb1_second = cq.Edge.makeSpline([cq.Vector(p) for p in coords_hgjb1_second][0:-1]).close()
...
solid_hgjb1[0] = solid_hgjb1[0].transformed((0,0,0),(0,-7.5,20))
